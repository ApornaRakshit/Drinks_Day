    ...
    allItems.forEach(item => {
        ...
        <div class="card rounded-3 w-75 h-100 ms-5">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"></p>
                <br>
                <button class="btn btn-info" onclick="handleAddToCart('${element.idDrink}', '${element?.strDrink}')">Add to cart</button>
                <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="getSingleItem('${element.idDrink}')">Details</button>
            </div>
        </div>
            `;
